        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div class="mt-6 mb-2">
                <div class="flex justify-between">
                    <h2 class="text-2xl font-medium text-indigo-600">Teste</h2>
                    <div class="col-md-2">
                        <x-select.styled :options="[
                            ['label' => 'Modelo', 'value' => 1],
                            ['label' => 'Menor Preço', 'value' => 2],
                            ['label' => 'Maior Preço', 'value' => 3],
                            ['label' => 'Menor Ano', 'value' => 4],
                            ['label' => 'Maior Ano', 'value' => 5],
                        ]" select="label:label|value:value" placeholder="Pesquisa"
                            required searchable />
