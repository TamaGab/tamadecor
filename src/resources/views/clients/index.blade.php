                                    ...
                                    <td class="px-4 py-2 text-right">
                                        <div class="flex items-center justify-end gap-3">
                                            ...
                                            <form method="POST" action="{{ route('clients.destroy', $client->id) }}">
                                                ...
                                                <div x-data>
                                                    <x-modal id="modal-delete{{ $client->id }}">
                                                        <x-slot:title>
                                                        ...
                                                        <div class="flex justify-end gap-2">
                                                            <x-secondary-button
                                                                x-on:click="$modalClose('modal-delete{{ $client->id }}')"
                                                                type="button">
                                                                Cancelar
                                                            </x-secondary-button>

                                                            <x-primary-button
                                                                x-on:click.prevent="$modalClose('modal-delete{{ $client->id }}'); $el.closest('form').submit();"
                                                                type="button">
                                                                Excluir
                                                            </x-primary-button>
                                                        </div>
                                                    ...
                                                    <button type="button"
                                                        x-on:click="$modalOpen('modal-delete{{ $client->id }}')"
